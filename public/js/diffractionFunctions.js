...
function drawKikuchiLines(canvas, xOffset, yOffset, radiusX, radiusY, r1, r2, dx, dy, angle, specimenThickness, beamRadius, i, j){
    ...
    if (canvas.getContext) {
        ...
        let r1LineTransparency = Math.min(specimenThickness / 500 / r1, 1);
        let r2LineWidthX = radiusX * 3 / 8 * r2 / Math.min(r1, r2);
        let r2LineWidthY = radiusY * 3 / 8 * r2 / Math.min(r1, r2);
        let r2LineTransparency = Math.min(specimenThickness / 500 / r2, 1);
        ...
        gradient.addColorStop(1, 'rgba(255,255,255,' + Math.min(specimenThickness / 5000, 1) + ')');
